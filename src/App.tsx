    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-brand-gray">
        <div className="text-center">
          ...
          <p className="text-brand-gray-dark font-medium">Loading GigsConnect...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-brand-gray p-4">
        <div className="bg-white p-8 rounded-3xl shadow-xl max-w-md w-full text-center border border-red-100">
          ...
          <h2 className="text-2xl font-bold text-brand-black mb-2">Connection Error</h2>
          <p className="text-brand-gray-dark mb-8">{error}</p>
          <button 
            onClick={() => window.location.reload()}
            className="w-full py-4 bg-brand-purple text-white font-bold rounded-xl hover:bg-brand-purple-dark transition-all shadow-lg shadow-purple-200"
          >
            Try Again
          </button>
        </div>
